...
-- ID_TASK = 5L
INSERT INTO task(label, firstPrevisionalDate, secondPrevisionalDate, endingDate) VALUES('testFindableLabelDB', '2000-12-10', '2000-12-17');

-- TaskDaoTest
-- testTaskIsFindableByIdUserBetweenPrevisionalDateAndEndingDate
-- ID_TASK = 6L
INSERT INTO task(label, previsionalDate, endingDate, id_user) VALUES('testFindableLabelDB', '2000-12-10', '2000-12-17', 1);
